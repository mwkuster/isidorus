;; code taken from Peter Seibel's practicals-1.0.3.tar.gz (http://www.gigamonkeys.com/book/)
;; in accordance to its license, cf. isidorus/src/externals/PRACTICALS_LICENSE.
